...
const News = ({ results }) => {
  return (
    <div className="grid h-[35rem] tablet:grid-cols-2 relative top-16 sm2:p-2 p-4 gap-x-4 gap-y-8 place-items-start grid-rows-[min-content] mb-[35rem] sm:mb-[45rem] md:mb-[50rem] tablet:mb-44 2xl:mb-52">
