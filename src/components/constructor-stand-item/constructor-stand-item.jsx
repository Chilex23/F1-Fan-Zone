...
const ConstructorStandItem = ({ constructor }) => {
    ...
    return (
        <Link to={`/constructors_list/${constructorId}`} className="group sm2:w-[97%] w-[80%] relative tablet:top-[-5rem] mt-2 mx-auto bg-white px-4 py-3 hover:bg-gray-800 hover:dark:text-white hover:text-white rounded-lg flex justify-between cursor-pointer text-black">
