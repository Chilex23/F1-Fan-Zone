...
const TopThree = ({ driver, order }) => {
  ...
  return (
    <div
      className={`h-fit w-[25%] order-${order} rounded-lg relative top-[-2rem] bg-stone-800 dark:bg-stone-900`}
    >
      <div className="bg-white rounded-t-lg relative">
        <p className="text-red-600 font-extrabold text-7xl absolute left-8 top-5">
          {position}
        </p>
      ...
      <div className="px-2 py-4">
        <p className="flex gap-2">
          {givenName}
          <img
            src={findDriver(givenName).country}
