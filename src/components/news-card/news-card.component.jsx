...
const NewsCard = ({ news }) => {
  ...
  return (
    <div className="card card-compact w-[95%] mx-auto homePhone:w-[48%] bg-base-100 shadow-2xl dark:bg-gray-800">
      <figure className="h-[10rem] overflow-clip">
        <img src={image.url} alt="headline" />
      </figure>
      <div className="card-body border-r-2 border-b-2 hover:border-red-600 rounded-br-2xl">
        ...
        <p className="font-bold text-ellipsis text-md tablet:text-lg">
          {title}
        </p>
